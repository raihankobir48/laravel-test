          ...
          <div class="comment-area mt-4 mb-5">
              ...
              <ul class="comment-tree list-unstyled">
                  <li class="mb-5">
                      <div class="comment-area-box">
                          <div class="comment-thumb float-left">
                              <img alt="" src="{{asset('front-end-assets')}}/images/blog/testimonial1.jpg" class="img-fluid">
                          </div>
                  ...
                  <li>
                      <div class="comment-area-box">
                          <div class="comment-thumb float-left">
                              <img alt="" src="{{asset('front-end-assets')}}/images/blog/testimonial2.jpg" class="img-fluid">
                          </div>
